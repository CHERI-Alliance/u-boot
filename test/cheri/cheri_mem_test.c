...
static int cheri_mem_memcpy_cap(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_memcpy_cap, 0);

static int cheri_mem_memmove_cap(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_memmove_cap, 0);

static int cheri_mem_stack_permission(struct unit_test_state *uts)
{
	char array[10];
...
CHERI_TEST(cheri_mem_stack_permission, 0);

static int cheri_mem_malloc_smallbin(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_malloc_smallbin, 0);

static int cheri_mem_malloc_bin(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_malloc_bin, 0);

static int cheri_mem_malloc_non_aligned_bound(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_malloc_non_aligned_bound, 0);

static int cheri_mem_realloc_non_aligned_bound(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_realloc_non_aligned_bound, 0);

static int cheri_mem_realloc_non_aligned_bound_backward(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_realloc_non_aligned_bound_backward, 0);

static int cheri_mem_realloc_non_aligned_bound_backward_forward(struct unit_test_state *uts)
{
	/* Allocate 4K pages as much as possible          */
	/* Assume the latest pages are on the top of heap */
#define MAX_NO_OF_PAGE		2500
...
CHERI_TEST(cheri_mem_realloc_non_aligned_bound_backward_forward, 0);

static int cheri_mem_realloc_non_aligned_bound_forward(struct unit_test_state *uts)
{
	/* Allocate 4K pages as much as possible          */
	/* Assume the latest pages are on the top of heap */
#define MAX_NO_OF_PAGE		2500
...
CHERI_TEST(cheri_mem_realloc_non_aligned_bound_forward, 0);

static int cheri_mem_realloc_non_aligned_bound_top(struct unit_test_state *uts)
{
	/* Allocate 4K pages as much as possible          */
	/* Assume the latest pages are on the top of heap */
#define MAX_NO_OF_PAGE		2500
...
CHERI_TEST(cheri_mem_realloc_non_aligned_bound_top, 0);

static int cheri_mem_calloc_simple(struct unit_test_state *uts)
{
	/* Test calloc */
...
CHERI_TEST(cheri_mem_calloc_simple, 0);

static int cheri_mem_memalign_simple(struct unit_test_state *uts)
{
	/* Test memalign */
	size_t alloc_len = 300UL;
...
CHERI_TEST(cheri_mem_memalign_simple, 0);

static int cheri_mem_valloc_simple(struct unit_test_state *uts)
{
	/* Test valloc */
	size_t alloc_len = 300UL;
...
CHERI_TEST(cheri_mem_valloc_simple, 0);

static int cheri_mem_pvalloc_simple(struct unit_test_state *uts)
{
	/* Test pvalloc */
	size_t alloc_len = 300UL;
...
CHERI_TEST(cheri_mem_pvalloc_simple, 0);

static int cheri_mem_malloc_permission(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_malloc_permission, 0);

static int cheri_mem_realloc_permission(struct unit_test_state *uts)
{
	char *ptr = (char *)malloc(300UL);
...
CHERI_TEST(cheri_mem_realloc_permission, 0);
...
static int cheri_mem_qsort_struct(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_qsort_struct, 0);
...
static int cheri_mem_qsort_ptr(struct unit_test_state *uts)
{
...
CHERI_TEST(cheri_mem_qsort_ptr, 0);
