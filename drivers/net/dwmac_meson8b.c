...
static const struct udevice_id dwmac_meson8b_ids[] = {
	{ .compatible = "amlogic,meson-gxbb-dwmac", .data = (uintptr_t)dwmac_setup_gx },
	{ .compatible = "amlogic,meson-g12a-dwmac", .data = (uintptr_t)dwmac_setup_axg },
	{ .compatible = "amlogic,meson-axg-dwmac", .data = (uintptr_t)dwmac_setup_axg },
	{ }
};
