...
static const struct udevice_id dwc3_glue_ids[] = {
	...
	{ .compatible = "ti,dwc3", .data = (uintptr_t)&ti_ops },
	{ .compatible = "ti,am437x-dwc3", .data = (uintptr_t)&ti_ops },
	{ .compatible = "ti,am654-dwc3" },
	{ .compatible = "rockchip,rk3328-dwc3", .data = (uintptr_t)&rk_ops },
	{ .compatible = "rockchip,rk3399-dwc3" },
	{ .compatible = "rockchip,rk3528-dwc3", .data = (uintptr_t)&rk_ops },
	{ .compatible = "rockchip,rk3568-dwc3", .data = (uintptr_t)&rk_ops },
	{ .compatible = "rockchip,rk3576-dwc3", .data = (uintptr_t)&rk_ops },
	{ .compatible = "rockchip,rk3588-dwc3", .data = (uintptr_t)&rk_ops },
	{ .compatible = "qcom,dwc3", .data = (uintptr_t)&qcom_ops },
	{ .compatible = "qcom,snps-dwc3", .data = (uintptr_t)&qcom_flat_dt_ops },
	{ .compatible = "fsl,imx8mp-dwc3", .data = (uintptr_t)&imx8mp_ops },
