...
static const struct udevice_id fsl_esdhc_ids[] = {
	...
	{ .compatible = "fsl,imx7d-usdhc", .data = (uintptr_t)&usdhc_imx7d_data,},
	{ .compatible = "fsl,imx7ulp-usdhc", .data = (uintptr_t)&usdhc_imx7ulp_data,},
	{ .compatible = "fsl,imx8qm-usdhc", .data = (uintptr_t)&usdhc_imx8qm_data,},
	{ .compatible = "fsl,imx8mm-usdhc", .data = (uintptr_t)&usdhc_imx8qm_data,},
	{ .compatible = "fsl,imx8mn-usdhc", .data = (uintptr_t)&usdhc_imx8qm_data,},
	{ .compatible = "fsl,imx8mp-usdhc", .data = (uintptr_t)&usdhc_imx8qm_data,},
	{ .compatible = "fsl,imx8mq-usdhc", .data = (uintptr_t)&usdhc_imx8qm_data,},
